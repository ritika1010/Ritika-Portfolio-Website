...
import TriviLogo from "../../Assets/trivia logo.png";
      ...
      <Container>
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <ProjectCard
              ...
              description="Our E-commerce Insights project delved into understanding customer satisfaction and product dynamics through advanced analytics techniques. 
              Leveraging XGBoost and Word2Vec embeddings, we attained a notable 68% accuracy and 0.85 AUC-ROC in predicting customer satisfaction ratings. Furthermore, we conducted multi-class classification to dissect the intricate relationship between business variables and customer satisfaction, mitigating class imbalances for a comprehensive analysis. 
              Additionally, through rigorous demographic and purchase behavior analysis, we successfully delineated three distinct customer clusters with an impressive 98% accuracy, offering invaluable insights for tailored marketing strategies and product development initiatives.
"
